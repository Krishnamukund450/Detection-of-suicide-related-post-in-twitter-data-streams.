                ...
                <div style="width:100%;" align="center" class="container">
                    <div style="float:left; width:100%; background-color: #ccc; " >
                        <div style="background-color: #fefefe">
                            <font style="font-family: cursive; color: #269abc "><strong><font size="5">User Details</font></strong></font><br><br>
                            <table>
                                <tr>
                                ...
                                <td><center><img src="view2.jsp?id=<%=rs.getString("id")%>" width="120" height="100"></center></td>
                                </tr>
                                <%
                                        }
                                    } catch (Exception ex) {
