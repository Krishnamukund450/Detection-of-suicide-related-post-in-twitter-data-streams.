                                            ...
                                            <div id="TweetModal" class="modal1" >
                                                <div class="modal-content1" style="background-color: #5bc0de">
                                                    ...
                                                    <div class="form1" style="background-color: #5bc0de">
                                                        ...
                                                        <form action="Retweets" method="post"  enctype="multipart/form-data"><br>
                                                            <center>
                                                                ...
                                                                <textarea name="msg1" readonly="" style="width: 360px; height: 100px; border-bottom-color: white; color: black;"><%=rs1.getString("username")%> @<%=rs1.getString("username")%><%=rs1.getString("msg")%></textarea><br>
