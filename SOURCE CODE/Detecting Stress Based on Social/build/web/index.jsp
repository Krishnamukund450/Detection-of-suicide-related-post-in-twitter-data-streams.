...
<body class="login">
    <h2 style="font-family: fantasy"><br><center>Detection of suicide-related posts in Twitter data streams in Social Networks</center></h2>
	<div class="logo">
            
	</div>
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="ulogin.jsp" method="get">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="pass"/>
					</div>
				</div>
			</div>
		...
		<form class="form-vertical forget-form" action="forgot.jsp" method="get">
		...
		<form class="form-vertical register-form" action="Registration" enctype="multipart/form-data" method="post">
			<h3 >Sign Up</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-ok"></i>
						<input class="m-wrap placeholder-no-fix" type="file" autocomplete="off" placeholder="Re-type Your Password" name="photo"/>
					</div>
				</div>
			</div>
			<div class="control-group">
